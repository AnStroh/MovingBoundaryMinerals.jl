...
function main()
    ...
    while t < t_tot
        ...
        if plot_sim
            ...
            p = plot!(x0,C0,color=:black,linestyle=:dash,xlabel = L"Distance", ylabel = L"Concentration", title = L"Diffusion\ couple\ (MB)", lw=1.5,
...
#Call main function-------------------------------------------------------------
x_left, x_right, dx1, dx2, x0, res, Ri, C_left, C_right, C0, Mass, Mass0 = main()
if plot_end
    #Plotting------------------------------------------------------
