...
function main(plot_sim,verbose)
    ...
    t                   = 0.0                                                                           #Time
    it                  = 0                                                                             #Iterations
    log10D_001          = log10(D0) - (Ea + (P-10^5)* deltaV)/(2.303*R*Tstart) + 3*((1-CompInt)-0.14)   #log10(diffusion coefficient Olivine) following Dohmen & Chakraborty (2007)                     
    ...
    while t < t_tot
        ...
        log10D_001    = log10(D0) - (Ea + (P-10^5)* deltaV)/(2.303*R*T) + 3*((1-CompInt)-0.14)          #log10(diffusion coefficient Olivine) following Dohmen & Chakraborty (2007)                     
        log10D_others = log10D_001 - log10(6.0)                                                         #log10(diffusion coefficient Olivine) following Dohmen & Chakraborty (2007)                     
        D_001         = 10^log10D_001                                                                   #Diffusion coefficient in direction 001
        D_010         = 10^log10D_others                                                                #Diffusion coefficient in direction 010
        D_100         = 10^log10D_others                                                                #Diffusion coefficient in direction 100
