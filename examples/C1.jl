...
#Main function----------------------------------------------------
function C1(;RefineMethod = 1, plot_sim = false, verbose= false)
...
if run_and_plot
    ...
    verbose   = false
    save_file = false
    x_left, x_right, x0, Ri, Ri0, C_left, C_right, C0, C0_r, n, maxC, KD0 = C1(RefineMethod = 1, plot_sim=plot_sim, verbose=verbose)
