...
# Description
This function loads an image and allows the user to interactively digitize points on the image. The digitized points are transformed based on the provided boundary conditions and can be exported to CSV files.
