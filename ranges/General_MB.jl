using MOBILE
using Plots, LinearAlgebra,  LaTeXStrings,SparseArrays, DataFrames,CSV,Serialization
#Main function----------------------------------------------------
function main(plot_sim,verbose,Di,D0,rho,Ri,Cl_i,Cr_i,V_ip,R,Ea1,Ea2,Myr2Sec,t_tot,n)
    ...
    while t < t_tot
        ...
        if plot_sim
            ...
            p = plot!(x0,C0,color=:black,linestyle=:dash,xlabel = L"Distance", ylabel = L"Composition", title = L"Diffusion\ couple\ 1D\ MB\ condition", lw=1.5,
