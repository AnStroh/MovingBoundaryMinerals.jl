...
B3 has no figure (it is not yet implemented, see above). D2 is a documentation example added after publication, not part of the paper — see [Example Gallery](@ref example-gallery) for its own figure.
