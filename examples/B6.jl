...
function main(plot_sim,verbose)
    ...
    return x_left, x_right, x0, Ri, Ri0, C_left, C_right, C0, C0_r, KD0, n, maxC, D_r, V_ip
end
#Call main function-----------------------------------------------
run_and_plot = true
if run_and_plot
    ...
    verbose   = false
    save_file = false
    x_left, x_right, x0, Ri, Ri0, C_left, C_right, C0, C0_r, KD0, n, maxC, D_r, V_ip = main(plot_sim,verbose)
    xan, Can = smith(x_right,C_right,Ri,D_r,t_tot,KD0,V_ip,n)
    if plot_end
        #Plotting------------------------------------------------------
