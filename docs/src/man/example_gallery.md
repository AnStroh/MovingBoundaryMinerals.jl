...
### `D2` — Thermodynamically constrained growth with a non-monotonic T-t path
...
![D2 example](../assets/examples/D2.png)
*Generated by [`D2.jl`](https://github.com/AnStroh/MovingBoundaryMinerals.jl/blob/main/examples/D2.jl).*

![D2 animation: composition profile and phase-diagram evolution over the full 30-day path](../assets/examples/D2.gif)
